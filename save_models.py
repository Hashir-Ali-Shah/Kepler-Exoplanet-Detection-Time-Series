# =============================================================================
# Save Final Models — run this cell after the training script completes
# Rebuilds each model, loads its trained weights, saves as .keras file
# =============================================================================
...
# INPUT_SHAPE must match what was used during training (timesteps, 1)
# timesteps = number of flux columns = 3197
INPUT_SHAPE = (3197, 1)
