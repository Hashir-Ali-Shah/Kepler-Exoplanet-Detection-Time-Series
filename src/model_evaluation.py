...
def preprocess_data(file_path):
    ...
    y = data['LABEL'] - 1  # Convert 1, 2 to 0, 1
    ...
    # 3. Reshaping for LSTM/GRU (samples, timesteps, 1)
...
def evaluate_keras_model(model_path, X_test, y_test):
    ...
    # Load the model
    # Note: If custom loss functions like Focal Loss were used, they might need to be passed in custom_objects
    # However, since we are just doing inference, loading and predicting should work if saved correctly.
    try:
